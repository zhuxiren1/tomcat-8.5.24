...
public class Catalina {
    ...
    public void load() {
        ...
        // Create and execute our Digester
        //定义解析server.xml的配置，告诉Digester哪个xml标签该解析成什么类
        Digester digester = createStartDigester();

        //首先尝试加载conf/server.xml;如果不存在则加载conf/server-embed.xml(该xml在catalina.jar中)；如果还是没有 就直接return
        ...
        try {
            ...
            try {
                ...
                //把catalina作为一个顶级实例
                digester.push(this);
                //解析过程会实例化各个组件，如server，Container,Connector
