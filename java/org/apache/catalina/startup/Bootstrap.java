...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        //通过反射实例化catalina，后面初始化catalina也用了很多反射
        ...
        //以下为反射调用setParentClassLoader方法，设置其parentClassLoader为sharedLoader
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                //实际上调用catalina.setawait()目的是为了让tomcat在关闭端口阻塞监听关闭命令
                daemon.setAwait(true);
                //实际上调用catalina.load()初始化一些资源 优先加载conf/server.xml, 找不到再去加载server-embed.xml, 此外 load方法还会初始化server
